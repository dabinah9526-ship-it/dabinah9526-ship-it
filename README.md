...
<h1>이다빈 · Backend Developer</h1>

<p>
<code>JAVA</code>&nbsp;&nbsp;·&nbsp;&nbsp;<code>SPRING BOOT</code>&nbsp;&nbsp;·&nbsp;&nbsp;<code>DATABASE</code>&nbsp;&nbsp;·&nbsp;&nbsp;<code>API</code>
</p>
...
| ID | 프로젝트 | 구분 | 담당 | 주요 기술 |
|:---:|:---|:---:|:---|:---|
| `P01` | **K-STEP** | 개인 프로젝트 | 기획, DB, API, 화면 연동 | React, Express, Oracle |
| `P02` | **UNIPET** | 팀 프로젝트 | 쇼핑몰, 커뮤니티 | Spring Boot, MyBatis, MySQL |
| `P03` | **따iT** | 팀 프로젝트 | 스터디, 커뮤니티 | Flutter, Firebase |
